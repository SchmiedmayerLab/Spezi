...
- Badges for Swift package-based Spezi modules to indicate the supported Swift version and operating systems, if those badges are generated by the current documentation hosting setup.
...
```md
For more information, please refer to the [API documentation](Spezi.md).
```

### Footer

The footer of all Spezi modules MUST include a link to the contributing guidelines, code of conduct, and license information.
Spezi modules in this monorepo SHOULD use the footer pattern below.
...
GitHub repository SHOULD include the main description of the Spezi module and SHOULD link to the configured hosted documentation in the sidebar of the GitHub repository.
GitHub tags like `Spezi` and others MAY be used to easily find the module on GitHub and other configured package catalogs.
